...
namespace NFL.Models
{
    ...
    {
        private const string TeamsKey = "myteams"; //key for favourite teams
        private const string CountKey = "teamcount"; //key for count of favourite teams
        private const string ConfKey = "conf"; //conf of each team
        private const string DivKey = "div"; // div of each team
